...
```{r graph_state_intervals, echo=FALSE, message=FALSE, fig.height=10, fig.width=16}
...
```{r graph_gender_votes, echo=FALSE, message=FALSE}
...
```{r popular vote, echo=FALSE, message=FALSE}
